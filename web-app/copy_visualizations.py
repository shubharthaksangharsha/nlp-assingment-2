...
This ensures that the web application can access and display the visualizations.
"""
...
def copy_visualizations():
    ...
    if not os.path.exists(data_viz_dir):
        print(f"Warning: Visualizations directory not found at {data_viz_dir}")
        return
    ...
    if not viz_files:
        print(f"Warning: No visualization images found in {data_viz_dir}")
        return
